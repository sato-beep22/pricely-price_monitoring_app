...
<body class="bg-base-100 relative">
    ...
    <div class="absolute w-80 h-80 rounded-full top-[15%] right-[5%] opacity-40 pointer-events-none animate-blob blur-2xl" style="background: radial-gradient(circle, rgba(56,189,248,0.25) 0%, rgba(99,102,241,0.10) 50%, transparent 70%); animation-delay: 2s;"></div>
    <div class="absolute w-72 h-72 rounded-full top-[50%] -left-16 opacity-35 pointer-events-none animate-blob blur-2xl" style="background: radial-gradient(circle, rgba(52,211,153,0.30) 0%, rgba(16,185,129,0.10) 50%, transparent 70%); animation-delay: 5s;"></div>
    ...
    <div class="absolute w-64 h-64 rounded-full bottom-[30%] left-[40%] opacity-25 pointer-events-none animate-blob blur-2xl" style="background: radial-gradient(circle, rgba(251,191,36,0.20) 0%, rgba(245,158,11,0.08) 50%, transparent 70%); animation-delay: 7s;"></div>
    <div class="absolute w-56 h-56 rounded-full top-[35%] right-[30%] opacity-30 pointer-events-none animate-blob blur-xl" style="background: radial-gradient(circle, rgba(99,102,241,0.18) 0%, rgba(139,92,246,0.06) 50%, transparent 70%); animation-delay: 10s;"></div>
