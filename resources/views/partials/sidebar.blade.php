<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" style="z-index: 9999;" class="fixed inset-y-0 left-0 w-72 flex-shrink-0 bg-white border-r border-slate-200 h-screen flex flex-col transition-transform duration-300 ease-in-out md:sticky md:top-0 md:translate-x-0">
