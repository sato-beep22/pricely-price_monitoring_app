<footer class="w-full border-t border-slate-100 bg-white py-12 text-slate-500 text-xs text-center relative z-20 mt-auto">
    <div class="max-w-7xl mx-auto px-6 md:px-8 space-y-4">
        <div class="flex items-center justify-center gap-2 text-slate-800 font-display font-medium">
        ...
        <div class="text-[10px] font-mono text-slate-450 mt-4">
            © {{ date('Y') }} Pricely. All rights reserved.
        </div>
    </div>
</footer>
