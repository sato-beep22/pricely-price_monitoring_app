...
class SendPriceUpdateSms
{
    ...
    {
        // defer() runs the code AFTER the response is sent to the user's browser.
        // This prevents the page from freezing, even without a queue worker!
